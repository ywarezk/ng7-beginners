...
var timerPromise = new Promise(function (resolve, reject) {
    setTimeout(function ( /*some condition*/) {
...
// await promise1
function waitForHelloPromise() {
    return __awaiter(this, void 0, void 0, function () {
        var helloWorld;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, timerPromise];
                case 1:
                    helloWorld = _a.sent();
                    return [2 /*return*/, helloWorld.length];
            }
        });
    });
}
var asyncLambda = function () { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/];
    });
}); };
